...
public class MainController {
    ...
    protected void parameters() throws IOException {
        if (image != null) {
            VBox analyseImageVB = FXMLLoader.load(Objects.requireNonNull(Main.class.getResource("parameters-view.fxml")));
    ...
    protected void analyse() throws IOException {
        if (searchedImage != null) {
            ...
            VBox detailsVB = FXMLLoader.load(Objects.requireNonNull(Main.class.getResource("analyse-view.fxml")));
    ...
    protected void visualize() throws IOException {
        if (searchedImage != null) {
            VBox detailsVB = FXMLLoader.load(Objects.requireNonNull(Main.class.getResource("visualize-view.fxml")));
